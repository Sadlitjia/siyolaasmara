                ...
                <section class="section">
                    <div class="card">
                        ...
                        <div class="tambah_data ">
                            <a href="<?= base_url('Aspirasi_mandiriController/tambah_data') ?>" type="button" class="ms-4 mb-2 btn btn-primary">Tambah Data</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center float-end ">
                                                <a href="<?= base_url('Aspirasi_mandiriController/edit_data') ?>"><span class="badge bg-warning">Edit</span></a>
